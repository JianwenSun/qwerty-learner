...
export default function SentenceChip({ sentence }: { sentence: SentenceAndSound }) {
  ...
  const { play, stop } = useUrlPronunciationSound(sentence.soundUrl)

...
import Phonetic from '@/pages/Typing/WordTyping/components/WordPanel/components/Phonetic'
import Letter from '@/pages/Typing/WordTyping/components/WordPanel/components/Word/Letter'
...
const RowDetail: React.FC<RowDetailProps> = ({ currentRowDetail, allRecords }) => {
  ...
  const dictInfo = wordDictionaryMap[currentRowDetail.dict]

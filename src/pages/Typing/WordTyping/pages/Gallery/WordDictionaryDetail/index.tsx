...
import WordChapter from '../WordChapter'
import { WordErrorTable } from '../WordErrorTable'
import { getRowsFromErrorWordData } from '../WordErrorTable/columns'
import { WordReviewDetail } from '../WordReviewDetail'
      ...
      <div className="flex pl-0">
        <Tabs value={curTab} className="h-[30rem] w-full ">
          ...
          <TabsContent value={Tab.Errors} className="h-full">
            <WordErrorTable data={tableData} isLoading={isLoading} error={error} onDelete={onDelete} />
          </TabsContent>
          <TabsContent value={Tab.Review} className="h-full">
            <WordReviewDetail errorData={errorWordData} wordDictionary={wordDictionary} />
          </TabsContent>
        </Tabs>
      </div>
    </div>

...
describe('SentenceSplitter', () => {
  describe('dash handling', () => {
    it('should handle multiple dashes in sentences', async () => {
      // 测试用例: 包含多个破折号
      const testContent = 'The winner is—drumroll please—John! He won by a landslide.';

      // 创建测试输入
      const testInput: PassageInput = {
        title: 'Multiple Dashes Test',
        content: testContent,
        author: 'Unknown'
      };

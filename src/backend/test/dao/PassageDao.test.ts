...
describe('PassageDaoTest', () => {
  let passageDao: PassageDao;
  ...
  describe('savePassage', () => {
    it('should save a new passage successfully', async () => {
      ...
      const savedPassage = await passageDao.savePassage(passageData, [testSentence]);
    ...
    it('should return existing passage when saving duplicate', async () => {
      ...
      await passageDao.savePassage(passageData, [testSentence]);
